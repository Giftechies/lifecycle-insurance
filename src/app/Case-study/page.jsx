...
export default function Case_study() {
  const cardData = [
    ...
    },
    {
      ...
      content: "Life Insurance, Health Insurance, Motor Insurance, Home Insurance, Travel Insurance, Business Insurance"
    },
    {
    ...
    },
    {
      ...
      content: "Deductible: The amount you pay before insurance starts paying. Policyholder: The owner of the policy."
    },
    {
