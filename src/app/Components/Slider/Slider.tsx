...
import { useRouter } from "next/navigation";
 ...
 const items = [
    ...
    return(
        ...
        <a href="tel:0800 50 7770" className="flex  cursor-pointer items-start gap-1 mt-3" ><i className="ri-phone-line text-2xl   "></i><h2 className=" font-medium"> 0800 50 7770</h2></a> 
        <a href="mailto:harpreet@lifecyclefinancial.co.nz" className=" cursor-pointer flex items-start gap-1 mt-1 text-[14px] "><i className="ri-mail-line  text-2xl"></i><h2> harpreet@lifecyclefinancial.co.nz</h2> </a>
