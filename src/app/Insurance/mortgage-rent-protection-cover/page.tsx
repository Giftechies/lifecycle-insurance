          ...
          <section className=" section_1 w-full   ">
            ...
            <div className="upperContent w-full ">
              <h1 className=" text-[var(--primg)] lg:text-[18px] ">
                <i className="ri-record-circle-line mr-1.5 text-[18px] lg:text-[18px]  "></i>Mortgage & Rent Protection Cover
              </h1>
           ...
           <div className=" mt-4 ">
            ...
            {How.map((el)=>(
              ...
              <div className=" flex items-start mt-2.5 " >
                <i className="ri-arrow-right-s-line "></i><p className=" text-[14px] " ><span className=" font-semibold " >{el.title}</span>{el.content}</p>
