...
export default function Mortgage() {
   ...
   const card= [
      ...
      {img:"https://plus.unsplash.com/premium_photo-1678139636101-d9eeee5c67f1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGZpbmFuY2lhbCUyMGRvY3VtZW50c3xlbnwwfHwwfHx8MA%3D%3D",
        ...
        month:'jun',
        heading:"Refinance",
        li:'http://localhost:3000/Mortgage/refinance',
        content:"Save more with our easy refinancing options. Lower your interest rate, reduce monthly payments, and simplify your finances without the hassle."
      },
      {img:"https://media.istockphoto.com/id/2198966747/photo/couple-closing-real-estate-contract-with-real-estate-agent.webp?a=1&b=1&s=612x612&w=0&k=20&c=MRupwwS_sR21cACmOIEPxd5ykbXbZsxLoc_oKUsaNhc=",
        ...
        li:'http://localhost:3000/Mortgage/investment-loan',
        content:"Build your wealth with our tailored investment loans. We help you maximize returns and grow your property portfolio with expert advice."
      },
      {img:"https://plus.unsplash.com/premium_photo-1661499804385-da9ba8357b14?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTN8fGJ1c2luZXNzJTIwb2ZmaWNlfGVufDB8fDB8fHww",
        ...
        li:'http://localhost:3000/Mortgage/business-loan',
        content:"Fuel your business ambitions with fast, flexible financing. Whether expanding or managing cash flow, our business loans adapt to your goals."
      },
      {img:"https://media.istockphoto.com/id/2173981229/photo/blurred-image-engineer-is-giving-advice-and-consulting-with-the-designer-to-find-out.webp?a=1&b=1&s=612x612&w=0&k=20&c=Has6w_cyklwmYGPZh5cUBXxb3C7uJ__9JkAwozKYNbY=",
        ...
        li:'http://localhost:3000/Mortgage/construction-loan',
        content:"Bring your building plans to life with structured funding at every stage. Our construction loans ensure your project stays on track and on budget."
      },
      {img:"https://images.unsplash.com/photo-1599580546666-c26f15e00933?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fGNvbW1lcmNpYWwlMjBidWlsZGluZ3xlbnwwfHwwfHx8MA%3D%3D",
        ...
        li:'http://localhost:3000/Mortgage/commercial-loan',
        content:"Finance commercial properties with confidence. We offer competitive rates and expert support for your business growth and investment needs."
      },
  ...
  return (
     <main className=" max-w-[1700px] m-auto  " >
          ...
          {/* section 1 */}
          <section className=" w-full px-4 bg-[#F7F4FB] overflow-hidden lg:flex  flex-col items-center justify-center lg:px-[9%] lg:py-10 max-w-[1500px] mx-auto  tracking-wider  ">
            {/* text */}
            <div  className=" h-[20%] w-full   mt-8 lg:flex gap-10">
              ...
              <div className=" w-full text-[var(--primg)]  text-[16px] lg:w-[55%] font-medium ">
                ...
                <p className=" text-[36px] leading-9  text-black lg:text-[36px] font-semibold mt-3 lg:leading-11">
                   Mortgage Solutions Crafted for Your Life.
                </p>
              </div>
    
              {/* right */}
              <div className=" w-full lg:w-[40%] mt-10   text-justify">
                {" "}
               Get expert guidance and flexible options to make home ownership easy. We’re here to help you finance your dreams with confidence.
              </div>
            </div>
    
            {/* cards */}
            <div className="  w-full lg:w-[97%] mt-10 lg:flex  flex-wrap gap-14 mb-4">
              ...
              {/* card  */}
                ...
                {/* Content */}
                <div className="px-[35px] py-4 h-70 ">
                  <h3 className="text-[25px] font-medium leading-7 text-gray-900 mb-2">
                   {el.heading}
                  </h3>
                  <p className="text-gray-700 text-[14px] mb-[20px] text-justify ">
                   {el.content}
                  ...
                  <a
                    href={el.li}
                    className="text-[var(--primg)] font-semibold text-sm hover:underline flex items-center gap-1 absolute bottom-9 left-9 "
                  >
                    Read More
