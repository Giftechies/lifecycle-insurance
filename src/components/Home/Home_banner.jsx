    ...
    <div className="relative  overflow-hidden">
      ...
      <div className=" relative  w-full h-full max-w-[1600px] mx-auto z-30">
        <div className="relative pt-25 px-4 md:px-[1.5rem]  lg:px-[3.5rem] xl:px-[3rem] lg:pt-50 pb-10 z-20 text-white ">
          ...
          <h4 className="mt-4 text-[14px] lg:w-[65%] text-white tracking-wider text-justify ">
            At LifeCycle Financial, we are an experienced and trusted financial advisory firm dedicated to helping Kiwis achieve financial confidence and long-term security. We provide a wide range of financial services, including residential and commercial mortgages, along with personal insurance products such as life insurance, medical insurance, trauma cover, income protection cover, and more.
          </h4>
